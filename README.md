...
- **GitHub Repository:** https://github.com/Amankhan2370/synthetic-image-forensics.git
- **Branch:** main
- **Total Files:** 118 (including models, datasets, and visualizations)
- **Last Updated:** February 28, 2026

### Quick Clone
```bash
git clone https://github.com/Amankhan2370/synthetic-image-forensics.git
cd synthetic-image-forensics
```
...
![Real vs AI Face](assets/images/real_vs_ai_faces.jpg)
...
![Bird Real vs AI](assets/images/real_vs_ai_bird.jpg)

Synthetic images generated by diffusion models can closely mimic real wildlife photography.

### Example 3 — Landscape Structure
![Bridge Real vs AI](assets/images/real_vs_ai_bridge.jpg)

Even structured scenes like architecture can be generated synthetically.

### Example 4 — High Resolution Facial Detail
![Real vs AI Pair 1](assets/images/real_vs_ai_pair1.jpg)

Small details such as skin texture, lighting consistency, and micro-patterns can reveal synthetic generation artifacts.

### Example 5 — Portrait Example
![Real vs AI Pair 2](assets/images/real_vs_ai_pair2.jpg)

The model learns to detect statistical signals rather than semantic appearance.
...
### Pre-trained Models
- **CNN ResNet-50 Model** (`outputs/models/cnn_resnet50.pt`) - 89.99 MB
- **Random Forest Forensic Model** (`outputs/models/random_forest_forensic.pkl`)
- **SVM Forensic Model** (`outputs/models/svm_forensic.pkl`)
- **Logistic Regression Forensic Model** (`outputs/models/log_reg_forensic.pkl`)

### Dataset
- **60 Sample Images** (30 real + 30 synthetic)
- Located in `data/real/` and `data/synthetic/`
- PNG format, ready for training and evaluation

### Generated Visualizations (23 plots in `outputs/plots/`)
- Sample grids, feature distributions, correlation matrices
- Confusion matrices, ROC curves, PR curves
- Grad-CAM visualizations, SHAP summaries
- FFT examples, noise analysis, texture analysis
- Training history and model comparison results
